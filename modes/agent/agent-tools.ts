...
export function createAgentTools(executor: ToolExecutor) {
    return {
        ...
        create_file: tool({
            ...
            inputSchema: z.object({
                path: z.string().describe("Relative file path"),
                content: z.string().describe("Contents for the file"),
            }),
        ...
        modify_file: tool({
            ...
            inputSchema: z.object({
                path: z.string().describe("Relative file path"),
                content: z.string().describe("New content of the modified file"),
            }),
        ...
        create_folder: tool({
            description: "Stage creation of a directory tree (pending approval). Uses mkdir -p on apply.",
            inputSchema: z.object({
        ...
        read_skill: tool({
            ...
            inputSchema: z.object({
                path: z.string().describe("Relative file path to file containing skills."),
            }),
