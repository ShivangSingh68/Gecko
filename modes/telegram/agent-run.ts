...
import { defaultAgentConfig, type AgentConfig } from "../agent/types.js";
import { createWebTools } from "../plan/web-tools.js";
import type { Plan, PlanStep } from "../plan/types.js";
import { replyMd } from "./text.js";
import { finishOrApprove } from "./approval-session.js";
...
function extraWebTool(tracker: ActionTracker) {
...
export async function runAsk(ctx: {reply:(t: string, o?: object)=>Promise<unknown>}, question: string) {
    ...
    const tools = {...createReadOnlyTools(executor), ...extraWebTool(tracker)};
